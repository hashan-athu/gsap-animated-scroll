...
let scrollTL = null; // keep reference
...
function initializeScrollAnimation() {
  ...
  const updateTitles = (index) => {
    titles.forEach((title, i) => {
      title.classList.toggle("active", i === index); // 🔴 REPLACED (logic same, cleaner)
    });
...
function destroyScrollAnimation() {
  ...
  console.log("GSAP Scroll Demo Destroyed");
}
